...
def getEdges(img):
    ...
    # Apply bilateral filter to the original image for edge-preserving smoothing
    ...
    masked_blur = cv2.bitwise_and(blur, blur, mask=mask)

    # Apply Canny Edge Detection
    edges = cv2.Canny(masked_blur, 50, 150)
